...
def contact():
    mess._show(title='Contact me', message="Please contact me on : 'Sejaldubal18@gmail.com' ")
...
def clear():
    txt.delete(0, 'end')
    res = "Take Images and then Save your Profile"
...
trainImg = tk.Button(frame2, text="Delete profile", command=psw ,fg="white"  ,bg="blue"  ,width=25  ,height=1, activebackground = "white" ,font=('times', 15, ' bold '))
trainImg.place(x=90, y=490)
